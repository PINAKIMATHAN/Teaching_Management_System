...
from .views import view_timetable
...
urlpatterns = [
    ...
    path('fees/', views.fee_management, name='fees'),
    ...
    path('student/results/', views.student_result, name='student_result'),
    ...
    path('staff/timetable/', views.view_timetable, name='staff_view_timetable'),
    path('student/timetable/', views.view_timetable, name='student_view_timetable'),
...
path('admin/home/', views.dashboard, name='admin_home'),
